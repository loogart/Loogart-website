...
<head>
    ...
    <meta name="description" content="Illustration of Montreal's Cityscape by Loogart. Created by Loogart for various cities - coined as a CityLine - such as Toronto, Ottawa, Zurich, New York, Los Angeles, Canada.">
    ...
    <meta property="og:image" content="http://loogart.com/img/portfolio/citylines/print-montreal-1.jpg">
...
<body>
    ...
    <main></main>
    <div class="project-jumbotron project-montreal-cityline-img"></div>
        ...
        <section class="portfolio-content">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                    <h1>Montréal CityLine Illustrations</h1>
                    <p>Illustration created to feature Montreal's popular landmarks and elements in the simplest way. Bold lines are married to circular anchors that hold the design together. Sixteen Montreal boroughs have been illustrated.</p>
                </div>
            </div>
            <div class="row">
                <div class="carousel">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                    ...
                    <p>I have illustrated several other CityLines for different locations. Some of these designs are also available for purchase on apparel and swag at <a href="http://kalooba.ca" target="_blank">Kalooba</a>.</p>
                </div>
            </div>
            <div class="row">
                <div class="carousel">
            ...
            <!-- third section: Special Edition CityLines -->
            <div class="row">
                <div class="col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                    <h3>Montreal Special Edition Citylines</h3>
                    <p>A collection of CityLines based on different locations or for special events.</p>
                </div>
            </div>
            <div class="row">
                <div class="carousel">
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h3>The story behind the CityLine</h3>
                    <p>In the Summer of 2013, one of my best friends commissioned me to create a piece of art for his new apartment. The subject of this piece: Montreal City. We agreed on specific landmarks and elements that pertain to the city.</p>
                    <p> This project sat on my desk for quite some time until I decided to try something in November 2013. Within minutes, I created the center of the piece and within several hours, the full illustration was complete: thick bold lines, a minimal color palette and circular hollow anchors with a Montreal vibe.</p>
                    <p>This piece was well received by my friends and fellow Montrealers. It was also an award-nominated design during the 2014 Concours L'Expo+ and caught the attention of Montreal media.</p>
                </div>
            </div>
            <!-- section 5: printed products-->
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h3>On the streets</h3>
                    <p>Here is some photography of the artwork printed or used in different situations.</p>
                </div>
            </div>
            <div class="row">
    ...
    <script>fbq('track', 'ViewMTLCityline');</script>
