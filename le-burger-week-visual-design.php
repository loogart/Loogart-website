...
<head>
    ...
    <meta property="og:image" content="http://loogart.com/img/portfolio/burgerweek/.jpg">
...
<body>
    ...
    <main>
        <div class="project-jumbotron" style="height:24vh;background-color:#4E2D2D"></div>
    ...
    <script>fbq('track', 'ViewBurgerWeek');</script>
