...
<head>
    ...
    <meta name="description" content="Illustration of Ecole de technologie supérieure's CityLine for marketing materials, apparel and social media use.">
    ...
    <meta property="og:image" content="https://loogart.com/img/portfolio/ets/ets-cityline-zoom.jpg">
...
<body>
    ...
    <main>
        ...
        <section class="portfolio-content">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                    <h3>Innovation</h3>
                    <p>The ETS differentiate themselves by tailoring their brand to a bold and fresh look which helps them gain traction for student recruitment and increases existing student interaction.</p>
                </div>
    ...
    <script>fbq('track', 'ViewETS');</script>
