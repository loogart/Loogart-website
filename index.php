    ...
    <main class="container">
        ...
        <section class="portfolio portfolio__loogmoji">
            <div class="row">
                <div class="container">
                    <h3>Loogmoji</h3>
                    <h4>Iconic pop-culture emojis designed by Loogart, just for fun. Want your own <a href="http://loogart.tictail.com/product/original-loogmoji" target="_blank">custom Loogmoji?</a></h4>
                    <div class="scroll">
                        ...
                        <a href="loogmoji#ironMan"><img class="carousel-loogs" src="./img/loogmoji/animated/loogmoji-animated-ironman-by-loogart.gif" alt="Animated Loogmoji of Ironman by Loogart" title="Ironman"></a>
                        <a href="loogmoji#gordonRamsay"><img class="carousel-loogs" src="./img/loogmoji/animated/loogmoji-animated-gordon-ramsay-by-loogart.gif" alt="Animated Loogmoji of Gordon Ramsay by Loogart" title="Gordon Ramsay"></a>
                        ...
                        <a href="loogmoji#ronaldMcDonald"><img class="carousel-loogs" src="./img/loogmoji/animated/loogmoji-animated-ronald-mcdonald-by-loogart.gif" alt="Animated Loogmoji of Ronald McDonald by Loogart" title="Ronald McDonald"></a>
