    ...
    <main class="container">
        ...
        <section class="portfolio portfolio__loogmoji">
            <div class="row">
                <div class="container">
                    <h3>Loogmoji</h3>
                    <h4>Iconic pop-culture emojis designed by Loogart, just for fun. Want your own <a href="http://loogart.tictail.com/product/loogmoji" target="_blank">custom Loogmoji?</a></h4>
                    <div class="scroll">
